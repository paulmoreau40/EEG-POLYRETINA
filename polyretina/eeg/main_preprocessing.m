% The main_preprocessing.m script serves as the core component for 
% preprocessing EEG data in this project. It orchestrates a series of steps 
% to import raw XDF files, prepare the data by removing artifacts and bad channels, 
% apply Independent Component Analysis (ICA) for signal decomposition, 
% and label the components based on their characteristics. 
%
% The outputs generated by this script are essential for subsequent analyses 
% conducted in main_single_participant_analysis.m.
