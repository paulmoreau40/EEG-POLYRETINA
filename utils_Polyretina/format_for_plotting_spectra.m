...
EEG_selected_spectrum_all_trials.srate = EEG_selected_spectrum_FoV_Brain_Area_freqs.P1.srate;
EEG_selected_spectrum_all_trials.chanlocs = EEG_selected_spectrum_FoV_Brain_Area_freqs.P1.chanlocs;

% Retrieving information related to frequency
spectrum_concatenated_all_trials = [];
EEG_selected_spectrum_all_trials.freqs = EEG_selected_spectrum_FoV_Brain_Area_freqs.P1.freqs;
...
for p = 1:length(participants)
    ...
    spectrum_for_this_participant = EEG_selected_spectrum_FoV_Brain_Area_freqs.(['P' participants(p)]).relative_spectrum(:,:,:);
