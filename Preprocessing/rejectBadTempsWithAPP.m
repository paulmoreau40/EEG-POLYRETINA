...
Data = EEG_epoched.data(:,:,epochs2use);
...
[Epoch_mean_amp_diff,~] = Biweight_custom(Amp_diffs', EEG_epoched.nbchan, cfg.APP.censorBiweight);
...
[Chans_mean,~] = Biweight_custom(reshape(Data, EEG_epoched.nbchan, sz_2), sz_2,...
